...
draw_text_colour(display_get_gui_width()/4,block1_y,"jogar",c_white,c_white,c_white,c_white,1)
draw_text_colour(display_get_gui_width()/4,block2_y,"opções",c_white,c_white,c_white,c_white,1)
draw_text_colour(display_get_gui_width()/4,block3_y,"sair",c_white,c_white,c_white,c_white,1)
