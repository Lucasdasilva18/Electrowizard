...
//desenhando texto da derrota

draw_text_colour(display_get_gui_width()/2,display_get_gui_height()*1.5/6,txt_derrota,c_red,c_red,c_red,c_red,1)


draw_text_colour(display_get_gui_width()/2,block1_y,"Reiniciar nível ",c_white,c_white,c_white,c_white,1)
draw_text_colour(display_get_gui_width()/2,block2_y,"Tela Cheia: " +texto_tela_cheia(),c_white,c_white,c_white,c_white,1)
draw_text_colour(display_get_gui_width()/2,block3_y,"Menu Principal",c_white,c_white,c_white,c_white,1)
