...
if construido>0{
	...
	if instance_exists(alvo) and distance_to_object(alvo)<45{
		if energia>=30 and alvo!=noone {
			...
			if recarga_handle==temp_recarg{
				...
				instance_create_depth(x+lengthdir_x(10,angulo),y-3+lengthdir_y(10,angulo),depth-1,ob_bala_canhao_bomba,{direction:angulo,speed:2.5,dano:dano})
